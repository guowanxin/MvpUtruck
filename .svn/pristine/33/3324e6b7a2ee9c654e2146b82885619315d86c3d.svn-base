...
import tdh.ifm.android.imatch.app.ui.activity.driver.RegisterDriverActivity;
...
//        Util.intentToActivity(context,ShipperRegisterActivity.class);
        CommonUtil.getToast(context,"该功能暂未开放，敬请期待");
    }
...
//        Util.intentToActivity(context,CompanyRegisterActivity.class);
    ...
    public void onViewClicked() {
        Util.intentToActivity(context,RegisterDriverActivity.class);
    }
}
