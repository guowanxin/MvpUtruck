...
public interface UserModel {
    ...
    interface OnRegisterDriverListener extends BaseListener{
        void onRegisterDriverSuccess(BaseResponse<User> baseResponse);
    }

    interface OnRegisterAgentListener extends BaseListener {
        void onRegisterAgentSuccess(BaseResponse<User> baseResponse);
    }
