...
import tdh.ifm.android.imatch.app.ui.activity.shipper.TransportControlActivity;
...
public class MyFragment extends BaseFragment implements MyView {
    ...
    public void initData() {
        ...
        if (userType.equals(Constants.USERTYPE_S)) {
            ...
            ivUserType.setImageResource(R.mipmap.icon_shipper);
            ...
            ivUserType.setImageResource(R.mipmap.icon_driver);
        }else if (userType.equals(Constants.USERTYPE_AGENT)) {
            llAttentionLine.setVisibility(View.VISIBLE);
            llTransportationControl.setVisibility(View.GONE);

            ivUserType.setImageResource(R.mipmap.icon_agent);
        }else if (userType.equals(Constants.USERTYPE_L)) {
            llAttentionLine.setVisibility(View.VISIBLE);
            llTransportationControl.setVisibility(View.VISIBLE);

            ivUserType.setImageResource(R.mipmap.icon_logistics);
        }
    ...
    public void onViewClicked() {
        Util.intentToActivity(context, TransportControlActivity.class);
    }
