            ...
            case 0:
                ...
                if (webViewFragment1 == null) {
                    ...
                    try {
                        ...
                        bundle.putString(Constants.URL, NetContant.HTML_SHOUYE+"?userType="+ SharedPreferencesUtil.
                                getValue(Constants.USERTYPE,"")+"&loginToken="+SharedPreferencesUtil.getValue(Constants.TOKEN,""));
